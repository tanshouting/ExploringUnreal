...
TSharedPtr< FSlateStyleSet > FEditorExtendStyle::StyleInstance = NULL;
...
TSharedRef< FSlateStyleSet > FEditorExtendStyle::Create()
{
	...
	Style->SetContentRoot(IPluginManager::Get().FindPlugin("EditorExtend")->GetBaseDir() / TEXT("Resources"));

	Style->Set("EditorExtend.OpenPluginWindow", new IMAGE_BRUSH(TEXT("ButtonIcon_40x"), Icon40x40));
